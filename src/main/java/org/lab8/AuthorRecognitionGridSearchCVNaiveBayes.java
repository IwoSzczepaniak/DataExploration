...
public class AuthorRecognitionGridSearchCVNaiveBayes {
    private static void performGridSearchCV(SparkSession spark, String filename) {
        ...
        // Configure parameter grid with Scala conversion for model type
    ...
    public static void main(String[] args) {
        SparkSession spark = SparkSession.builder()
                .appName("Author Recognition using Naive Bayes with Grid Search CV")
                .master("local[*]")
                .getOrCreate();

        performGridSearchCV(spark, "src/main/resources/books/two-books-all-1000-1-stem.csv");
